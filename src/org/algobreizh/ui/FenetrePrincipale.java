...
public class FenetrePrincipale extends JFrame {
	...
	/**
	 * R�cup�re les informations dans la base de don�nes
	 * et remplis la table client avec ces derni�res
	 */
	private void fillTabClient()
	{
		...
		try {
			...
			TableModel model = new DefaultTableModel(data, columnNames) {
				...
				//Desactive l'�dition de la cellule au double click
				@Override
			...
			//Double sort pour ranger par ordre d�croissant
	...
	/**
	 * Connecte les boutons aux diff�rents listeners
	 */
	...
	/**
	 * Cr�er le model de la table client, permet d'activer
	 * ou non certains boutons en fonction de la s�lection
	 * d'une ligne
	 */
	...
	/**
	 * R�cup�re l'id du client de la ligne s�lectionn�e
	 * @return id du client de la ligne s�lectionn�e
	 */
	...
	/**
	 * Mets en place les diff�rents composants de la fen�tre
	 * et les place sur cette derni�re
	 */
